<template>
    <section class="min-h-screen">
        ...
        <!-- Bank icon markup -->
         <div 
            class="container flex items-center justify-around mt-8">
            <div 
                class="bankOne w-16 h-16 rounded-full shadow-md"
            >
            ...
            <div 
                class="bankOne w-16 h-16 rounded-full shadow-sm py-2 bg-gray-200"
            >
                <div 
                ...
                >
                    ...
                    />
                    <p
                        class="font-manrope text-primary font-bold"
                        >more</p>
                </div>
            </div>
         </div>
         ...
         <!-- Payment Selection Markup -->
          <div 
            class="container flex flex-col items-center justify-around mt-8"
            >
            <!-- <p>
         ...
         <!-- Payment Selection Markup -->
          <div 
            class="container flex flex-col items-center mt-8 space-y-4"
          >
            <p class="font-bold">
              Instant payment notification
            </p>
              <span
                class="font-manrope text-gray-500 font-light"
...
// Navigating to Saved Cards
const navigateToSavedCards = () => {
  const router = useRouter();
  router.push('/SavedCards')
}
