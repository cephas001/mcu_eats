  ...
  <section class="pb-5 pt-15 px-6">
    ...
    <UForm class="mb-5 flex flex-col gap-3" :state="profileRegistrationForm">
      ...
      <FormField
        ...
        @update="profileRegistrationForm.vendorValue = $event"
      />
      <!-- VENDOR EMAIL FIELD -->
      <FormField
        ...
        type="email"
        :state="profileRegistrationForm"
        :items="profileRegistrationForm.vendorEmail"
    ...
    const { savedProfile, updatedUser } =
      await $expressUserBackendService.createProfile({
        ...
        data: {
          ...
          vendorAddress: profileRegistrationForm.vendorAddress?.toString().trim(),
        },
      });
